...
import { InformationCircleIcon as InformationCircleOutlineIcon } from '@heroicons/vue/24/outline'
import { InformationCircleIcon as InformationCircleSolidIcon } from '@heroicons/vue/24/solid'
...
<template>
  <div class="hidden lg:flex border-b border-gray-200 dark:border-zinc-700 py-3 items-center justify-between px-8">
    ...
    <div class="flex items-center gap-1.5">
      <NuxtLink :to="localePath(`/c/${currentClass.hash}/edit`)" class="text-gray-600 hover:text-gray-800 dark:text-zinc-200 dark:hover:text-white">
